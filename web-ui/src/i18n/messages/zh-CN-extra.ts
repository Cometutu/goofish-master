const zhCNExtra = {
  tasks: {
    ...
    form: {
      ...
      hotnessDescriptionHint: '热度模式下可留空；仅用于备注。',
      ...
      hotnessConfig: '热度阈值配置',
      hotnessConfigHint: '设置收藏/想要/浏览的每分钟速率阈值。留空的指标不参与判定。至少需要配置一个阈值。',
      hotnessCollect: '收藏/分钟',
      hotnessWant: '想要/分钟',
      hotnessBrowse: '浏览/分钟',
      hotnessConditionLogic: '条件逻辑',
      hotnessLogicOr: 'OR（任一达标即推荐）',
      hotnessLogicAnd: 'AND（全部达标才推荐）',
      hotnessMaxMonitorHours: '最大监测时长(小时)',
      hotnessMaxCheckCount: '最大巡检次数',
      hotnessMaxRecheckPerRun: '每轮巡检上限',
      hotnessThresholdPlaceholder: '不限',
      hotnessOptionalPlaceholder: '不限',
      priceRange: '价格范围',
      minPrice: '最低价',
      maxPrice: '最高价',
      maxPages: '搜索页数',
      ...
      validation: {
        ...
        hotnessThresholdRequired: '热度模式下至少需要配置一个阈值（收藏/想要/浏览）。',
      },
    },
    region: {

const enUSExtra = {
  tasks: {
    ...
    form: {
      ...
      hotnessDescriptionHint: 'Optional in hotness mode; used as a note only.',
      ...
      hotnessConfig: 'Hotness Thresholds',
      hotnessConfigHint: 'Set per-minute rate thresholds for favorites/wants/views. Empty fields are ignored. At least one threshold is required.',
      hotnessCollect: 'Favorites/min',
      hotnessWant: 'Wants/min',
      hotnessBrowse: 'Views/min',
      hotnessConditionLogic: 'Condition Logic',
      hotnessLogicOr: 'OR (any threshold met)',
      hotnessLogicAnd: 'AND (all thresholds met)',
      hotnessMaxMonitorHours: 'Max Monitor Hours',
      hotnessMaxCheckCount: 'Max Check Count',
      hotnessMaxRecheckPerRun: 'Max Recheck Per Run',
      hotnessThresholdPlaceholder: 'No limit',
      hotnessOptionalPlaceholder: 'No limit',
      ...
      validation: {
        ...
        hotnessThresholdRequired: 'At least one threshold (favorites/wants/views) is required in hotness mode.',
      },
    },
    region: {
